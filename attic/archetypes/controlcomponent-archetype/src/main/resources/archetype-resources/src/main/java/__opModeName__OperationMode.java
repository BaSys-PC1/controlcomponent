...
@OperationMode(name = "${opModeName.toLowerCase()}", shortName = "${opModeShortName}", description = "${opModeDescription}", 
		allowedCommands = {	ExecutionCommand.HOLD, ExecutionCommand.RESET, ExecutionCommand.START, ExecutionCommand.STOP }, 
		allowedModes = { ExecutionMode.PRODUCTION, ExecutionMode.SIMULATION })
public class ${opModeName}OperationMode extends BaseOperationMode {
	...
	public ${opModeName}OperationMode(BaseControlComponent component) {
		super(component);
	}
