...
public class ProfilesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProfilesPackage.CONTROL_COMPONENT_SPECIFICATION: {
				ControlComponentSpecification controlComponentSpecification = (ControlComponentSpecification)theEObject;
				T result = caseControlComponentSpecification(controlComponentSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProfilesPackage.PROFILES: {
				Profiles profiles = (Profiles)theEObject;
				T result = caseProfiles(profiles);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProfilesPackage.PROFILE: {
				Profile profile = (Profile)theEObject;
				T result = caseProfile(profile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProfilesPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProfilesPackage.NODE_SET: {
				NodeSet nodeSet = (NodeSet)theEObject;
				T result = caseNodeSet(nodeSet);
				if (result == null) result = caseNode(nodeSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProfilesPackage.VARIABLE: {
			...
			case ProfilesPackage.PROFILE_REQUIREMENT: {
				ProfileRequirement profileRequirement = (ProfileRequirement)theEObject;
				T result = caseProfileRequirement(profileRequirement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProfilesPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProfilesPackage.INPUT_PARAMETER: {
			...
			case ProfilesPackage.OUTPUT_PARAMETER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Control Component Specification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Control Component Specification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseControlComponentSpecification(ControlComponentSpecification object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Profile Requirement</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Profile Requirement</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProfileRequirement(ProfileRequirement object) {
		return null;
	}
