...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.controlcomponent.profiles.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider extends NodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProfilesPackage.Literals.VARIABLE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addWriteablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_writeable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_writeable_feature", "_UI_Variable_type"),
				 ProfilesPackage.Literals.VARIABLE__WRITEABLE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		...
		if (var.isWriteable()) 
			return overlayImage(object, getResourceLocator().getImage("full/obj16/VariableWriteable.png"));
		else 
